...
public class ExceptionHandlerAdvice {
    ...
    public Map<String,Object> feignException(FeignException exception, HttpServletResponse response){
        int httpStarus = exception.status();
        if (httpStarus >= HttpStatus.INTERNAL_SERVER_ERROR.value()){
        ...
        data.put("code",httpStarus+"");
        response.setStatus(httpStarus);
        return data;
    }
    ...
    public Map<String,Object> bedRequestExcetion(IllegalArgumentException exception){
        Map<String,Object> data = new HashMap<>();
